...
void FRAM_MB85RC_I2C::begin(void) {
	...
	// 			Serial.print("Memory Chip initialized");
	// 			FRAM_MB85RC_I2C::deviceIDs2Serial();
	// 		}
	// 		else {
	// 			Serial.print("Memory Chip NOT FOUND");
	// 		}
	// 		Serial.print("...... ...... ......");
	// 	}
    // #endif
...
byte FRAM_MB85RC_I2C::eraseDevice(void) {
		...
		#ifdef SERIAL_DEBUG
			if (Serial){
				Serial.print("Start erasing device");
			}
		#endif
...
byte FRAM_MB85RC_I2C::deviceIDs2Serial(void) {
	...
	#if defined(SERIAL_DEBUG) && (SERIAL_DEBUG == 1)
		if (Serial){
			Serial.print("FRAM Device IDs");
			Serial.print("Manufacturer 0x"); //Serial.print(manufacturer, HEX);
			Serial.print("ProductID 0x"); //Serial.print(productid, HEX);
			Serial.print("Density code 0x"); //Serial.print(densitycode, HEX);
			Serial.print("Density "); //Serial.print(density, DEC); Serial.print("K");
			if ((manufacturer != MANUALMODE_MANUFACT_ID) && (density > 0))  Serial.print("Device identfied automatically");
			if ((manufacturer == MANUALMODE_MANUFACT_ID) && (density > 0))  Serial.print("Device properties set");
			Serial.print("...... ...... ......");
			result = ERROR_0;
		}
    #endif
